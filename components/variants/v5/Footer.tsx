    ...
    <footer className={styles.foot}>
      <div className={styles.container}>
          ...
          <div className={styles.footBrand}>
            <div className={styles.footLogo}>
              ...
              <span className={styles.footLogoText}>
                <span className={styles.footLogoL1}>
                  Textile Development Foundation
                </span>
                <span className={styles.footLogoL2}>Est. 1995 &middot; Solapur</span>
              </span>
            </div>
        ...
        <div className={styles.footSign}>
          <span className={styles.footSignText}>
            <em>Ledgered at Akkalkot Road</em> &middot; MIDC &middot; Solapur &middot; 413006
          </span>
          <span className={styles.footSignSeal}>
            <WaxSeal
              size={54}
              label="TDF"
              title="Seal of the Textile Development Foundation, Solapur"
            />
          </span>
        </div>
