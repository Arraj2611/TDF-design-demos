    ...
    <footer className={styles.foot}>
      <div className={styles.container}>
          ...
          <div className={styles.footBrand}>
            <div className={styles.footLogo}>
              ...
              <span className={styles.footLogoText}>
                <span className={styles.footLogoL1}>TDF · Monograph</span>
                <span className={styles.footLogoL2}>Plate Vol. VI &middot; Solapur</span>
              </span>
            </div>
        ...
        <div className={styles.footStamp}>
          The Textile Development Foundation &middot; Monograph &middot; Solapur &middot; 2026
        </div>
