    ...
    <section id="events" className={clsx(styles.section, styles.container)}>
      <Reveal>
        <div className={styles.sectionHead}>
          <span className={styles.sectionNo}>§ VII</span>
          <span className={styles.sectionKicker}>
            Part VII <span className="sep" aria-hidden="true" />
            Calendar
          </span>
      ...
      <div className={styles.secFoot}>
        <span>§ VII &middot; No. {t.num} &middot; Calendar</span>
