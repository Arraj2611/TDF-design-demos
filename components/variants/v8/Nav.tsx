...
// Hoisted: the anchor map is configuration, not component state.
const LINKS = [
  { id: 'about', key: 'about' },
      ...
      <div className={clsx(styles.container, styles.navInner)}>
        <a href="#top" className={styles.navLogo} aria-label="TDF home">
          ...
          <span className={styles.navLogoText}>
            <span className={styles.navLogoTextL1}>TDF</span>
            <span className={styles.navLogoTextL2}>Export Portfolio &middot; Solapur</span>
          </span>
        </a>
        ...
        <div className={styles.navRight}>
          <BilingualToggle />
          <a href="#contact" className={styles.navSub}>
